...
int main_AGC(void)
{
    ...
    char out_pcm[32] = "ns_out_8k.pcm";
#else
    char in_pcm[32]  = "agc_in.pcm";
    char out_pcm[32] = "agc_output.pcm";
#endif
#else
    char in_pcm[32]  = "output_test.pcm";
    char out_pcm[32] = "ns_output_test.pcm";
    ...
    ST_AUD_AGC_RTN stAgcRtn;
    ST_AUD_AGC_INFO stAgcInfoPre;
    void *pInternalBuf;
    int s32RealCount = 0;
    ...
    // API
    stAgcInfoPre.s32FrameSize    = NN;
    stAgcInfoPre.s32ChannelNum   = CH;
    ...
    int i = 1;
    AUD_AGC_SetParam(EN_AUD_AGC_AGC, (void *)&i);
    AUD_AGC_SetParam(EN_AUD_AGC_DENOISE, (void *)&i);
    i= -20;
    AUD_AGC_SetParam(EN_AUD_AGC_NOISE_SUPPRESS, (void *)&i);
    i = 6000;
    AUD_AGC_SetParam(EN_AUD_AGC_AGC_LEVEL, (void *)&i);
    i = 20;
    AUD_AGC_SetParam(EN_AUD_AGC_AGC_MAX_GAIN, (void *)&i);
